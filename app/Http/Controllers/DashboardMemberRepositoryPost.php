...
class DashboardMemberRepositoryPost extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('dashboard.memberrepositorylabss.index', [
            'title' => 'Repository Management',
            "repositories" => Repositorylabs::where('user_id', auth()->user()->id)->latest()->filter(request(['search', 'labscategory', 'author']))->paginate(6)->withQueryString()
        ]);
    }
    ...
    {
        return view('dashboard.memberrepositorylabss.add', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/memberlabs')->with('success', 'New repository has been added!');
    }
    ...
    public function show(Repositorylabs $repositorylabs)
    {
        if($repositorylabs->user_id != auth()->user()->id){
            return redirect('/dashboard/memberlabs')->with('warning', 'Invalid Post');
        }
        return view('dashboard.memberrepositorylabss.detail', [
    ...
    public function edit(Repositorylabs $repositorylabs)
    {
        ...
        return view('dashboard.memberrepositorylabss.edit', [
    ...
    public function update(Request $request, Repositorylabs $repositorylabs)
    {
        ...
        return redirect('/dashboard/memberlabs')->with('success', 'Repository has been updated!');
    }
    ...
    public function destroy(Repositorylabs $repositorylabs)
    {
        ...
        return redirect('/dashboard/memberlabs')->with('success', 'Repository has been deleted!');
    }
