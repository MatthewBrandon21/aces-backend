...
class DashboardAdminImageFolder extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('dashboard.adminimagefolder.index', [
            'title' => 'Admin Image Folder',
            "images" => Imagefolder::latest()->filter(request(['author']))->paginate(6)->withQueryString()
        ]);
    }
    ...
    {
        return view('dashboard.adminimagefolder.add', [
            'title' => "Add Image"
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/adminimagefolder')->with('success', 'New image has been added!');
    }
    ...
    public function destroy(Imagefolder $imagefolder)
    {
        ...
        return redirect('/dashboard/adminimagefolder')->with('success', 'Image has been deleted!');
    }
}
