...
class ContactusController extends Controller
{
    ...
    {
        $title = '';
        return view('dashboard.admincontactus.index', [
    ...
    {
        return view('dashboard.admincontactus.detail', [
    ...
    public function destroy(Contactus $contactus)
    {
        ...
        return redirect('/dashboard/admin-contactus')->with('success', 'Data has been deleted!');
    }
}
