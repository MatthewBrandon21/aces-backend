    ...
    <div class="section-body">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
                <form method="POST" action="{{  url('') }}/dashboard/memberlabs/{{ $repository->slug }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
...
@section('pagespecificjs')
  <script>
    ...
    title.addEventListener('change', function(){
        fetch('<?php echo url('')?>/dashboard/memberlabs/checkSlug?title=' + title.value)
