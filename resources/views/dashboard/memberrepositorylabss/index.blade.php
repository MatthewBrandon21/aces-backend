...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a href="{{  url('') }}/dashboard/memberlabs/create" class="btn btn-primary">Add New</a>
    </div>
  ...
  <div class="section-body">
    ...
    <div class="row mb-3">
      <div class="col-md-6">
          <form action="{{  url('') }}/dashboard/memberlabs">
          ...
          <div class="col-12 col-md-4 col-lg-4">
            <article class="article article-style-c">
              <div class="article-header">
                ...
                @else
                <div class="article-badge">
                  <div class="article-badge-item bg-warning">Pending Review</div>
                </div>
                @endif
              </div>
              <div class="article-details">
                <div class="article-category"><a href="{{  url('') }}/dashboard/memberlabs?labscategory={{ $repository->labscategory->slug }}">{{ $repository->labscategory->name }}</a> <div class="bullet"></div> <a>{{ $repository->created_at->diffForHumans() }}</a></div>
                <div class="article-title">
                  <h2><a href="{{  url('') }}/dashboard/memberlabs/{{ $repository->slug }}">{{ $repository->title }}</a></h2>
                </div>
                ...
                <div class="article-user">
                  ...
                  <div class="article-user-details">
                    <div class="user-detail-name">
                      <a href="{{  url('') }}/dashboard/memberlabs?author={{ $repository->author->username }}">{{ $repository->author->name }}</a>
                    </div>
                  </div>
                </div>
              </div>
