    ...
    <div class="container">
        <div class="row justify-content-left">
            <div class="col-md-10">
                ...
                @endif
                <p class="h5">By. <a href="{{  url('') }}/dashboard/labs?author={{ $repository->author->username }}" class="text-decoration-none">{{ $repository->author->name }}</a> in <a href="{{  url('') }}/dashboard/labs?labscategory={{ $repository->labscategory->slug }}" class="text-decoration-none">{{ $repository->labscategory->name }}</a></p>
