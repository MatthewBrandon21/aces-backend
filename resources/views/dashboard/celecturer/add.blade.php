...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Create New Lecturer</div>
      </div>
    </div>

    <div class="section-body">
      <h2 class="section-title">Create New Lecturer</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Submit Lecturer data</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{  url('') }}/dashboard/lecturers" enctype="multipart/form-data">
                    @csrf
