...
<section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{  url('') }}/dashboard/websitegallery" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Add New Image</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="{{  url('') }}/dashboard">Dashboard</a></div>
        <div class="breadcrumb-item"><a href="{{  url('') }}/dashboard/websitegallery">Website Gallery</a></div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{  url('') }}/dashboard/websitegallery" enctype="multipart/form-data">
                    @csrf
