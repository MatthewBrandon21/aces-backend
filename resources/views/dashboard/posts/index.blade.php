...
<section class="section">
  ...
  <div class="section-body">
    ...
    <p class="section-lead">
      Click on category or author for posts filter.
    </p>
    <div class="row mb-3">
      <div class="col-md-6">
          ...
          <div class="col-12 col-md-4 col-lg-4">
            <article class="article article-style-c">
              <div class="article-header">
                @if ($post->image)
                  <div class="article-image" data-background="{{ asset('storage/' . $post->image) }}">
                @else
                  <div class="article-image" data-background="https://source.unsplash.com/500x400/?{{ $post->category->name }}">
                @endif
                </div>
                @if ($post->published)
