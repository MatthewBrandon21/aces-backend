                ...
                <form method="POST" action="{{  url('') }}/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" id="title" name="title" value="{{ old('title', $post->title) }}" class="form-control @error('title') is-invalid @enderror" required autofocus>
                            @error('title')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" id="slug" name="slug" value="{{ old('slug', $post->slug) }}" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    @if ($post->image)
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->title }}" style="height: 250px">
                            </div>
                        </div>
                    @endif
                    <div class="form-group row mb-4">
...
@section('pagespecificjs')
  <script>
    ...
    title.addEventListener('change', function(){
        fetch('<?php echo url('')?>/dashboard/posts/checkSlug?title=' + title.value)
