...
<section class="section">
  <div class="section-header">
    <h1>ACES Admin Image Folder</h1>
    <div class="section-header-button">
      <a href="{{  url('') }}/dashboard/adminimagefolder/create" class="btn btn-primary">Add New</a>
    </div>
  ...
  <div class="section-body">
    ...
    <p class="section-lead">
      All pictures uploaded by members for their posts. Click on author for Images filter.
    </p>
    <div class="row mb-3">
      <div class="col-md-6">
          <form action="{{  url('') }}/dashboard/adminimagefolder">
              @if (request('author'))
            ...
            <article class="article article-style-c">
              ...
              <div class="article-details">
                ...
                <div class="row d-flex justify-content-center">
                  ...
                  <div class="p-2">
                    <form action="{{  url('') }}/dashboard/adminimagefolder/{{ $image->id }}" method="POST" class="d-inline">
                      @method('delete')
                      @csrf
                ...
                <div class="article-user">
                  ...
                  <div class="article-user-details">
                    <div class="user-detail-name">
                      <a href="{{  url('') }}/dashboard/adminimagefolder?author={{ $image->author->username }}">{{ $image->author->name }}</a>
                    </div>
                  </div>
                </div>
              </div>
