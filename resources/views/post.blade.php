    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-8">
                ...
                <h5 class="mb-5">Category : <a href="{{  url('') }}/blog?category={{ $post->category->slug }}" class="text-decoration-none">{{ $post->category->name }}</a></h5>
                @if ($post->image)
                ...
                <a href="{{  url('') }}/blog" class="text-decoration-none">Back to blog</a>
            </div>
        </div>
    </div>
@endsection
